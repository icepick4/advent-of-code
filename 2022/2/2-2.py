...
def findWeaponAgainst(weapon, typeOfMatch):
    if (weapon == 'A' and typeOfMatch == 'X') or (weapon == 'B' and typeOfMatch == 'Z') or (weapon == 'C' and typeOfMatch == 'Y'):
        return 'Z'
    elif (weapon == 'C' and typeOfMatch == 'X') or (weapon == 'A' and typeOfMatch == 'Z') or (weapon == 'B' and typeOfMatch == 'Y'):
        return 'Y'
    elif (weapon == 'B' and typeOfMatch == 'X') or (weapon == 'C' and typeOfMatch == 'Z') or (weapon == 'A' and typeOfMatch == 'Y'):
        return 'X'
...
if __name__ == '__main__':
    ...
    SUM = 0
    for round in rounds:
        SUM += result(round[0], findWeaponAgainst(round[0], round[1]))
    print(SUM)
